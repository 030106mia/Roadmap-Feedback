...
INSERT INTO "new_UserFeedback" ("content", "createdAt", "device", "email", "feedbackType", "id", "kind", "sortOrder", "todo", "updatedAt", "userName") SELECT "content", "createdAt", "device", "email", "feedbackType", "id", "kind", "sortOrder", "todo", "updatedAt", "userName" FROM "UserFeedback";
